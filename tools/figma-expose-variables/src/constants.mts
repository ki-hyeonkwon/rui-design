export const VARIABLE_TABLE_HEADER_TITLE = "RUI" as const satisfies TextNode["characters"];
...
export const VARIABLE_TABLE_NAME_HYPERLINKS = {
  Semantic: "https://rui-design.io/docs/foundation/color/palette",
  Palettes: "https://rui-design.io/docs/foundation/color/palette",
