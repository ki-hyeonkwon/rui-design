...
export async function GET() {
  return new Response(`# RUI Design - Documentation for LLMs

RUI Design은 당근마켓의 디자인 시스템입니다.
이 문서는 대규모 언어 모델(LLM)이 RUI Design을 쉽게 이해할 수 있도록 구조화되어 있습니다.
...
- 모든 문서는 rui-design.io의 공식 문서와 동기화됩니다.
