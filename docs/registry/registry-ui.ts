  ...
  items: [
    {
      ...
      snippets: [
        {
          path: "app-screen.tsx",
          dependencies: { "@rui/react": "~1.0.0", "@rui/css": "~1.0.0" },
        },
        {
          path: "app-bar.tsx",
          dependencies: { "@rui/react": "~1.0.0", "@rui/css": "~1.0.0" },
      ...
      snippets: [
        {
          ...
          dependencies: { "@rui/react": "~1.1.0", "@rui/css": "~1.1.0" },
        },
      ],
    },
    {
    ...
    },
    {
      ...
      snippets: [
        {
          path: "checkbox.tsx",
          dependencies: { "@rui/react": "~1.2.0", "@rui/css": "~1.2.0" },
        },
      ],
    },
    {
      ...
      snippets: [
        {
          ...
          dependencies: { "@rui/react": "~1.3.0", "@rui/css": "~1.3.0" },
        },
      ],
    },
    {
