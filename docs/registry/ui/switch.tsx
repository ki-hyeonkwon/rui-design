...
import { Switch as SeedSwitch } from "@rui/react";
...
/**
 * @deprecated Use `Switchmark` instead. Will be removed in @rui/react@1.3.0.
 */
export const SwitchMark = Switchmark;

/**
 * @deprecated Use `SwitchmarkProps` instead. Will be removed in @rui/react@1.3.0.
 */
