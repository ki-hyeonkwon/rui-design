...
import { Switch as SeedSwitch } from "@rideds/react";
...
/**
 * @see https://rui-design.io/react/components/switch
 */
...
/**
 * @deprecated Use `Switchmark` instead. Will be removed in @rideds/react@1.3.0.
 */
export const SwitchMark = Switchmark;

/**
 * @deprecated Use `SwitchmarkProps` instead. Will be removed in @rideds/react@1.3.0.
 */
