...
- [`@seed-deesign/react-icon`](https://www.npmjs.com/package/@rui/react-icon)
- [`@rui/icon`](https://www.npmjs.com/package/@rui/icon) (deprecated)
...
- 다음 패키지를 사용하는 경우
  - [`@rui/vue2-icon`](https://www.npmjs.com/package/@rui/vue2-icon) → [`@daangn/vue2-monochrome-icon`](https://github.com/daangn/seed-icon-v3/pkgs/npm/vue2-monochrome-icon)으로 대체돼요.
  - [`@rui/vue3-icon`](https://www.npmjs.com/package/@rui/vue3-icon) → [`@daangn/vue3-monochrome-icon`](https://github.com/daangn/seed-icon-v3/pkgs/npm/vue3-monochrome-icon)으로 대체돼요.
...
```package-install
npm uninstall @rui/icon @rui/react-icon @karrotmarket/karrot-ui-icon
```
...
```package-install
npm uninstall @rui/icon @rui/react-icon @karrotmarket/karrot-ui-icon @rui/vue2-icon @rui/vue3-icon
```
