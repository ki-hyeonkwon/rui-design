...
```package-install
npx @rideds/cli@latest add ui:snackbar
```
...
<ComponentExample name="react/snackbar/positive">
  ```json doc-gen:file
  {
    "file": "examples/react/snackbar/positive.tsx",
    "codeblock": true
  }
  ```
</ComponentExample>
...
<ComponentExample name="react/snackbar/critical">
  ```json doc-gen:file
  {
    "file": "examples/react/snackbar/critical.tsx",
    "codeblock": true
  }
  ```
</ComponentExample>
...
- `@rideds/react@0.1.14`까지: `false`: 명시하지 않는 경우, 상호작용 여부와 관계없이 timeout이 지나면 dismiss됩니다.
- 이후 버전: `true`: 명시하지 않는 경우, 사용자가 상호작용하는 동안 timeout이 멈춥니다.

</Callout>

<ComponentExample name="react/snackbar/pause-on-interaction">
  ```json doc-gen:file
  {
    "file": "examples/react/snackbar/pause-on-interaction.tsx",
    "codeblock": true
  }
  ```
</ComponentExample>
...
<ComponentExample name="react/snackbar/avoid-overlap">
  ```json doc-gen:file
  {
    "file": "examples/react/snackbar/avoid-overlap.tsx",
    "codeblock": true
  }
  ```
</ComponentExample>
