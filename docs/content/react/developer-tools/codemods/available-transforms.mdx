...
```package-install
npx @rui/codemod@latest replace-custom-rui-typography <target_path>
```
...
```package-install
npx @rui/codemod@latest replace-tailwind-typography <target_path>
```
...
```package-install
npx @rui/codemod@latest replace-custom-imported-typography-variable <target_path>
```
...
```package-install
npx @rui/codemod@latest replace-custom-rui-vars <target_path>
```
...
```package-install
npx @rui/codemod@latest replace-stitches-styled-typography <target_path>
```
...
```package-install
npx @rui/codemod@latest replace-stitches-theme-color <target_path>
```
...
```package-install
npx @rui/codemod@latest replace-css-rui-color-variable <target_path>
```
...
```package-install
npx @rui/codemod@latest replace-react-icon <target_path>
```
...
```package-install
npx @rui/codemod@latest replace-rui-token-vars <target_path>
```
...
```package-install
npx @rui/codemod@latest replace-semantic-stroke-color <target_path>
```
...
```package-install
npx @rui/codemod@latest replace-custom-rui-text-component <target_path>
```
...
```package-install
npx @rui/codemod@latest replace-rui-token-typography-classname <target_path>
```
...
```package-install
npx @rui/codemod@latest replace-stitches-styled-color <target_path>
```
...
```package-install
npx @rui/codemod@latest replace-custom-text-component-color-prop <target_path>
```
...
```package-install
npx @rui/codemod@latest replace-alpha-color <target_path>
```
...
```package-install
npx @rui/codemod@latest replace-custom-rui-color <target_path>
```
...
```package-install
npx @rui/codemod@latest replace-custom-color-to-rui-vars-color <target_path>
```
...
```package-install
npx @rui/codemod@latest replace-css-rui-typography-variable <target_path>
```
...
```package-install
npx @rui/codemod@latest replace-tailwind-color <target_path>
```
