...
## replace-custom-rui-typography

```package-install
npx @rideds/codemod@latest replace-custom-rui-typography <target_path>
```
...
```package-install
npx @rideds/codemod@latest replace-tailwind-typography <target_path>
```
...
```package-install
npx @rideds/codemod@latest replace-custom-imported-typography-variable <target_path>
```
...
## replace-custom-rui-vars

```package-install
npx @rideds/codemod@latest replace-custom-rui-vars <target_path>
```
...
```package-install
npx @rideds/codemod@latest replace-stitches-styled-typography <target_path>
```
...
```package-install
npx @rideds/codemod@latest replace-stitches-theme-color <target_path>
```
...
```package-install
npx @rideds/codemod@latest replace-css-rui-color-variable <target_path>
```
...
:root[data-seed] {
  --rui-alert-dialog-backdrop-background: var(--rui-semantic-color-overlay-dim);
  --rui-alert-dialog-content-background: var(--rui-semantic-color-paper-dialog);
  --rui-alert-dialog-title-color: var(--rui-scale-color-gray-900);
  --rui-alert-dialog-description-color: var(--rui-scale-color-gray-900);

  --rui-box-button-focus-border: 2px solid var(--rui-scale-color-blue-600);

  box-shadow: 0 0 0 2px var(--rui-scale-color-blue-600);
  background: linear-gradient(to bottom, var(--rui-scale-color-blue-600), var(--rui-scale-color-blue-700));
}
```

```css title="basic.output.css"
:root[data-seed] {
  --rui-alert-dialog-backdrop-background: var(--rui-color-bg-overlay);
  --rui-alert-dialog-content-background: var(--rui-color-bg-layer-floating);
  --rui-alert-dialog-title-color: var(--rui-color-palette-gray-1000);
  --rui-alert-dialog-description-color: var(--rui-color-palette-gray-1000);

  --rui-box-button-focus-border: 2px solid var(--rui-color-palette-blue-600);

  box-shadow: 0 0 0 2px var(--rui-color-palette-blue-600);
  background: linear-gradient(to bottom, var(--rui-color-palette-blue-600), var(--rui-color-palette-blue-800));
}
```
...
```package-install
npx @rideds/codemod@latest replace-react-icon <target_path>
```
...
## replace-rui-token-vars

```package-install
npx @rideds/codemod@latest replace-rui-token-vars <target_path>
```
...
```package-install
npx @rideds/codemod@latest replace-semantic-stroke-color <target_path>
```
...
## replace-custom-rui-text-component

```package-install
npx @rideds/codemod@latest replace-custom-rui-text-component <target_path>
```
...
## replace-rui-token-typography-classname

```package-install
npx @rideds/codemod@latest replace-rui-token-typography-classname <target_path>
```
...
```package-install
npx @rideds/codemod@latest replace-stitches-styled-color <target_path>
```
...
```package-install
npx @rideds/codemod@latest replace-custom-text-component-color-prop <target_path>
```
...
```package-install
npx @rideds/codemod@latest replace-alpha-color <target_path>
```
...
```package-install
npx @rideds/codemod@latest replace-custom-rui-color <target_path>
```
...
```package-install
npx @rideds/codemod@latest replace-custom-color-to-rui-vars-color <target_path>
```
...
```package-install
npx @rideds/codemod@latest replace-css-rui-typography-variable <target_path>
```
...
```css title="basic.input.css"
/* Radio Label */
.rui-radio-group[data-size="small"] [data-part="radio-label"] {
  margin-inline-start: var(--rui-radio-small-label-margin-inline-start);
  margin-block-start: var(--rui-radio-small-label-margin-block-start);

  font-size: var(--rui-semantic-typography-label4-regular-font-size);
  font-weight: var(--rui-semantic-typography-label4-regular-font-weight);
  line-height: var(--rui-semantic-typography-label4-regular-line-height);
  letter-spacing: var(--rui-semantic-typography-label4-regular-letter-spacing);
}

.rui-radio-group[data-size="medium"] [data-part="radio-label"] {
  margin-inline-start: var(--rui-radio-medium-label-margin-inline-start);
  margin-block-start: var(--rui-radio-medium-label-margin-block-start);

  font-size: var(--rui-semantic-typography-label3-regular-font-size);
  font-weight: var(--rui-semantic-typography-label3-regular-font-weight);
  line-height: var(--rui-semantic-typography-label3-regular-line-height);
  letter-spacing: var(--rui-semantic-typography-label3-regular-letter-spacing);
}

.rui-radio-group[data-size="large"] [data-part="radio-label"] {
  margin-inline-start: var(--rui-radio-large-label-margin-inline-start);
  margin-block-start: var(--rui-radio-large-label-margin-block-start);

  font-size: var(--rui-semantic-typography-label2-regular-font-size);
  font-weight: var(--rui-semantic-typography-label2-regular-font-weight);
  line-height: var(--rui-semantic-typography-label2-regular-line-height);
  letter-spacing: var(--rui-semantic-typography-label2-regular-letter-spacing);
}
```
...
.rui-radio-group[data-size="small"] [data-part="radio-label"] {
  ...
  font-size: var(--rui-font-size-t2);
  font-weight: var(--rui-font-weight-regular);
  line-height: var(--rui-line-height-t2);
...
.rui-radio-group[data-size="medium"] [data-part="radio-label"] {
  ...
  font-size: var(--rui-font-size-t4);
  font-weight: var(--rui-font-weight-regular);
  line-height: var(--rui-line-height-t4);
  letter-spacing: normal;
}
...
.rui-radio-group[data-size="large"] [data-part="radio-label"] {
  ...
  font-size: var(--rui-font-size-t5);
  font-weight: var(--rui-font-weight-regular);
  line-height: var(--rui-line-height-t5);
  letter-spacing: normal;
}
```
...
```package-install
npx @rideds/codemod@latest replace-tailwind-color <target_path>
```
