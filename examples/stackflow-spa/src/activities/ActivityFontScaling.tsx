...
function useFontScalingMultiplier() {
  const attr = document.documentElement.getAttribute("data-rui-font-multiplier");
      ...
      <AppScreenContent>
        <VStack gap="spacingY.componentDefault" px="spacingX.globalGutter">
          <Callout
            ...
            description="SEED 번들러 플러그인의 fontScaling: true 옵션을 설정하면, 페이지 최초 로드 시 root element의 data-rui-font-multiplier 속성에 사용자의 폰트 스케일링 배율이 저장됩니다."
          />
          <VStack gap="x2" p="x1">
            ...
            {value === null && (
              <Text textStyle="t4Medium" color="fg.critical">
                data-rui-font-multiplier 속성이 설정되지 않았습니다. 번들러 플러그인에서
