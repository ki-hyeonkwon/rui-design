...
const REPO = "rui-design/rui-design";
...
function main() {
  ...
  for (const [i, release] of topLevelReleases.entries()) {
    ...
    const changelogUrl = `https://rui-design.io/react/updates/changelog?package=${encodeURIComponent(release.packageName)}&version=${encodeURIComponent(release.version)}`;
    const text = [
