...
- 사용자가 선호하는 컬러 스킴에 따라 `data-rui-scale-color` 어트리뷰트를 지정합니다.
- 시스템 폰트에 적합한 타이포그래피를 적용하기 위해 `data-rui-scale-letter-spacing` 어트리뷰트를 지정합니다.
  - ios
  - android
...
<html
  ...
  data-rui-scale-color="light"
  data-rui-scale-letter-spacing="ios"
>
  <head>
