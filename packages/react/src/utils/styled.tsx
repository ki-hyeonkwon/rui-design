...
function handleBleed(
  ...
  if (dimension === "asPadding") {
    return `var(--rui-box-padding-${direction})`;
  }
...
export function handlePaddingWithSafeArea(
  ...
  if (padding === "safeArea") {
    return `var(--rui-safe-area-${direction})`;
  }
...
export function useStyleProps<T extends UseStyleProps>(
  ...
  return {
    style: {
      "--rui-box-background": handleColor(background ?? bg) ?? gradientValue,
      "--rui-box-color": handleColor(color),
      "--rui-box-border-color": handleColor(borderColor),
      "--rui-box-border-width": borderWidth !== undefined ? `${borderWidth}px` : undefined,
      "--rui-box-border-top-width":
        borderTopWidth !== undefined ? `${borderTopWidth}px` : undefined,
      "--rui-box-border-right-width":
        borderRightWidth !== undefined ? `${borderRightWidth}px` : undefined,
      "--rui-box-border-bottom-width":
        borderBottomWidth !== undefined ? `${borderBottomWidth}px` : undefined,
      "--rui-box-border-left-width":
        borderLeftWidth !== undefined ? `${borderLeftWidth}px` : undefined,
      "--rui-box-border-radius": handleRadius(borderRadius),
      "--rui-box-border-top-left-radius": handleRadius(borderTopLeftRadius),
      "--rui-box-border-top-right-radius": handleRadius(borderTopRightRadius),
      "--rui-box-border-bottom-right-radius": handleRadius(borderBottomRightRadius),
      "--rui-box-border-bottom-left-radius": handleRadius(borderBottomLeftRadius),
      "--rui-box-box-shadow": handleShadow(boxShadow),
      "--rui-box-width": handleDimension(width),
      "--rui-box-min-width": handleDimension(minWidth),
      "--rui-box-max-width": handleDimension(maxWidth),
      "--rui-box-height": handleDimension(height),
      "--rui-box-min-height": handleDimension(minHeight),
      "--rui-box-max-height": handleDimension(maxHeight),
      "--rui-box-padding": handleDimension(padding ?? p),
      "--rui-box-padding-x": handleDimension(paddingX ?? px),
      "--rui-box-padding-y": handleDimension(paddingY ?? py),
      "--rui-box-padding-top": handlePaddingWithSafeArea(paddingTop ?? pt, "top"),
      "--rui-box-padding-right": handleDimension(paddingRight ?? pr),
      "--rui-box-padding-bottom": handlePaddingWithSafeArea(paddingBottom ?? pb, "bottom"),
      "--rui-box-padding-left": handleDimension(paddingLeft ?? pl),
      "--rui-box-bleed-top": handleBleed(bleedTop ?? bleedY, "top"),
      "--rui-box-bleed-right": handleBleed(bleedRight ?? bleedX, "right"),
      "--rui-box-bleed-bottom": handleBleed(bleedBottom ?? bleedY, "bottom"),
      "--rui-box-bleed-left": handleBleed(bleedLeft ?? bleedX, "left"),
      "--rui-box-top": top,
      "--rui-box-left": left,
      "--rui-box-right": right,
      "--rui-box-bottom": bottom,
      "--rui-box-gap": handleDimension(gap),
      "--rui-box-display": handleDisplay(display),
      "--rui-box-position": position,
      "--rui-box-overflow-x": overflowX,
      "--rui-box-overflow-y": overflowY,
      "--rui-box-z-index": zIndex,
      "--rui-box-flex-grow": flexGrow === true ? 1 : flexGrow,
      "--rui-box-flex-shrink": flexShrink === true ? 1 : flexShrink,
      "--rui-box-flex-direction": handleFlexDirection(flexDirection),
      "--rui-box-flex-wrap": flexWrap === true ? "wrap" : flexWrap,
      "--rui-box-justify-content": handleJustifyContent(justifyContent),
      "--rui-box-justify-self": justifySelf,
      "--rui-box-align-items": handleAlignItems(alignItems),
      "--rui-box-align-content": handleAlignItems(alignContent),
      "--rui-box-align-self": handleAlignItems(alignSelf),
      "--rui-box-grid-column": gridColumn,
      "--rui-box-grid-row": gridRow,
      "--rui-box-unstable-transform": unstable_transform,

      // Active
      "--rui-box-background--active": handleColor(_active?.bg ?? _active?.background),
      ...style,
