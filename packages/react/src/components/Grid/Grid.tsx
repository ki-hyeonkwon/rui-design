    ...
    <Box
      ...
      {...mergeProps(rest, {
        ...
        style: {
          ...
          "--rui-grid-rows": typeof rows === "number" ? `repeat(${rows}, minmax(0, 1fr))` : rows,
          "--rui-grid-auto-flow": autoFlow,
          "--rui-grid-auto-columns": autoColumns,
          "--rui-grid-auto-rows": autoRows,
          "--rui-grid-justify-items": justifyItems,
