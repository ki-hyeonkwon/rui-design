  ...
  (
    ...
    return (
      <Comp
        ...
        style={
          {
            "--rui-max-lines": maxLines,
            "--rui-text-color": handleColor(color),
            "--rui-font-size": handleFontSize(fontSize),
            "--rui-line-height": handleLineHeight(lineHeight ?? fontSize),
            "--rui-font-weight": handleFontWeight(fontWeight),
            "--rui-text-align": align,
            "--rui-user-select": userSelect,
            "--rui-white-space": whiteSpace,
            ...style,
