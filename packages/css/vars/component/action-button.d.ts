export declare const vars: {
  ...
  "variantBrandSolid": {
    "enabled": {
      ...
      "progressCircle": {
        "trackColor": "var(--rui-color-palette-static-white-alpha-300)",
        "rangeColor": "var(--rui-color-palette-static-white)"
      }
    },
    "pressed": {
      "root": {
  ...
  "variantCriticalSolid": {
    ...
    "pressed": {
      "root": {
        "color": "var(--rui-color-bg-critical-solid-pressed)"
      }
    },
    "disabled": {
      "root": {
  ...
  "variantBrandOutline": {
    "enabled": {
      ...
      "progressCircle": {
        "trackColor": "var(--rui-color-palette-carrot-200)",
        "rangeColor": "var(--rui-color-bg-brand-solid)"
      }
    },
    "pressed": {
      "root": {
  ...
  "sizeXsmall": {
    "enabled": {
      "root": {
        "minHeight": "var(--rui-dimension-x8)",
  ...
  "sizeXsmallLayoutWithText": {
    "enabled": {
      "root": {
        ...
        "paddingY": "var(--rui-dimension-x1_5)"
      },
      /** 주로 액션의 의미를 보조합니다. suffixIcon과 함께 사용할 수 없습니다. */
      "prefixIcon": {
  ...
  "sizeSmall": {
    "enabled": {
      "root": {
        "minHeight": "var(--rui-dimension-x9)",
  ...
  "sizeLarge": {
    "enabled": {
      "root": {
        "minHeight": "var(--rui-dimension-x13)",
  ...
  "sizeLargeLayoutWithText": {
    "enabled": {
      "root": {
        "gap": "var(--rui-dimension-x2)",
        "paddingX": "var(--rui-dimension-x5)",
        "paddingY": "var(--rui-dimension-x3_5)"
      },
      /** 주로 액션의 의미를 보조합니다. suffixIcon과 함께 사용할 수 없습니다. */
      "prefixIcon": {
        "size": "22px"
  ...
  "sizeLargeLayoutIconOnly": {
    "enabled": {
      "root": {
        "minWidth": "var(--rui-dimension-x13)",
        "paddingX": "var(--rui-dimension-x3_5)",
        "paddingY": "var(--rui-dimension-x3_5)"
      },
      /** layout=iconOnly에서 사용되는 아이콘 슬롯입니다. */
