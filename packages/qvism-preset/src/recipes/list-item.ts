...
const listItem = defineSlotRecipe({
  ...
  base: {
    ...
    prefix: {
      ...
      "--rui-box-padding-right": vars.base.enabled.prefix.paddingRight,
    ...
    suffix: {
      ...
      "--rui-box-gap": vars.base.enabled.suffix.gap,
      gap: "var(--rui-box-gap)",
    ...
    content: {
      ...
      border: "none",
      fontFamily: "inherit",
      "--rui-box-gap": vars.base.enabled.content.gap,
      gap: "var(--rui-box-gap)",
      "--rui-box-padding-right": vars.base.enabled.content.paddingRight,
      padding: "0 var(--rui-box-padding-right) 0 0",
