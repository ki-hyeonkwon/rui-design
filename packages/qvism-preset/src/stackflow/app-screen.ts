...
export const appScreen = defineSlotRecipe({
  ...
  base: {
    root: {
      ...
      "--app-bar-offset": "calc(var(--app-bar-height) + var(--rui-safe-area-top))",
    },
    dim: {
  ...
  variants: {
    ...
    layerOffsetBottom: {
      ...
      safeArea: {
        layer: {
          paddingBottom: "var(--rui-safe-area-bottom)",
        },
      },
    },
    tone: {
  ...
  compoundVariants: [
      ...
      css: {
        layer: {
          "&::before": {
            ...
            right: 0,
            top: 0,
            marginBottom: `calc(-1 * (66px + ${OVERSCROLL_GRADIENT_OFFSET} + var(--rui-safe-area-top)))`,
            height: `calc(66px + ${OVERSCROLL_GRADIENT_OFFSET} + var(--rui-safe-area-top))`,
    ...
    },
    {
      ...
      css: {
        layer: {
          "&::before": {
            transform: `translateY(calc(-${OVERSCROLL_GRADIENT_OFFSET} - var(--rui-safe-area-top)))`,
          },
        },
      },
    },
