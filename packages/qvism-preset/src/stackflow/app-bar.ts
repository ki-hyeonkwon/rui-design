...
export const appBar = defineSlotRecipe({
  ...
  variants: {
    theme: {
      cupertino: {
        root: {
          height: `calc(${vars.themeCupertino.enabled.root.minHeight} + var(--rui-safe-area-top))`,
          paddingLeft: vars.themeCupertino.enabled.root.paddingX,
          paddingRight: vars.themeCupertino.enabled.root.paddingX,
          paddingTop: "var(--rui-safe-area-top)",
        },
        iconButton: {
        ...
        icon: {
          width: `var(--rui-icon-size, ${vars.themeCupertino.enabled.icon.size})`,
          height: `var(--rui-icon-size, ${vars.themeCupertino.enabled.icon.size})`,
        },
      },
      android: {
        root: {
          height: `calc(${vars.themeAndroid.enabled.root.minHeight} + var(--rui-safe-area-top))`,
        ...
        icon: {
          width: `var(--rui-icon-size, ${vars.themeAndroid.enabled.icon.size})`,
          height: `var(--rui-icon-size, ${vars.themeAndroid.enabled.icon.size})`,
        },
        left: {
          paddingRight: "16px",
        },
    ...
    tone: {
      layer: {
        root: {
          "&:before": {
            background: `var(--rui-box-background, ${vars.toneLayer.enabled.root.color})`,
          },
        },
        icon: {
          color: `var(--rui-icon-color, ${vars.toneLayer.enabled.icon.color})`,
        },
      },
      transparent: {
        root: {
        ...
        icon: {
          color: `var(--rui-icon-color, ${vars.toneTransparent.enabled.icon.color})`,
        },
      },
    },
    divider: {
