export declare const vars: {
  "base": {
    "enabled": {
      "root": {
        ...
        "color": "var(--rui-color-palette-gray-600)",
        "colorDuration": "var(--rui-duration-d1)",
      ...
      "thumb": {
        "cornerRadius": "var(--rui-radius-full)",
        "scale": "0.8",
        "scaleDuration": "var(--rui-duration-d3)",
        "scaleTimingFunction": "var(--rui-timing-function-easing)",
    ...
    "disabled": {
      "root": {
        "opacity": "0.38",
        "opacityDuration": "var(--rui-duration-d1)",
        "opacityTimingFunction": "var(--rui-timing-function-easing)"
      }
    },
    "selected": {
      "thumb": {
  ...
  "toneNeutral": {
    ...
    "disabled": {
      "thumb": {
        "color": "var(--rui-color-palette-static-black-alpha-700)"
      }
    },
    "disabledSelected": {
      "root": {
