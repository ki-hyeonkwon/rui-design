...
export function enterAnimation(props: AnimationProps) {
  return {
    ...
    "--rui-enter-translate-x": props.translateX ?? "0",
    "--rui-enter-translate-y": props.translateY ?? "0",
    "--rui-enter-opacity": props.opacity?.toString() ?? "1",
    "--rui-enter-scale": props.scale?.toString() ?? "1",
  };
}
...
export function exitAnimation(props: AnimationProps) {
  return {
    ...
    "--rui-exit-translate-x": props.translateX ?? "0",
    "--rui-exit-translate-y": props.translateY ?? "0",
    "--rui-exit-opacity": props.opacity?.toString() ?? "1",
    "--rui-exit-scale": props.scale?.toString() ?? "1",
  };
}
