...
export default function generateSeedCss(
  ...
  const seedOptions = {
    ...
    banner:
      options?.banner ||
      `:root, [data-rui-color-mode="system"] {
...
`,
    selectors: {
      ...
      color: {
        "theme-light": `:root,
:root[data-rui-color-mode="system"][data-rui-user-color-scheme="light"],
:root[data-rui-color-mode="light-only"],
:root [data-rui-color-mode="light-only"]`,
        "theme-dark": `:root[data-rui-color-mode="system"][data-rui-user-color-scheme="dark"],
:root[data-rui-color-mode="dark-only"],
:root [data-rui-color-mode="dark-only"]`,
      },
    },
